...
const AnalysisRPrototype: FunctionComponent<AnalysisRPrototypeProps> = ({width, height}) => {
...
const AnalysisROutputWindow: FunctionComponent<AnalysisROutputWindowProps> = ({width, height, onOutputDiv}) => {
    return (
