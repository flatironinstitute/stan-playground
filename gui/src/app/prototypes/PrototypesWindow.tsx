...
type PrototypesWindowSelection =
  | "data.py"
  | "data.r"
  | "analysis.py"
  | "analysis.r";
...
const PrototypesWindow: FunctionComponent<TestDataPyWindowProps> = ({
  ...
  const [selection, setSelection] =
    useState<PrototypesWindowSelection>("data.py");
  ...
  return (
    ...
    >
        ...
        <div style={{ padding: 20 }}>
          ...
          <div>
            <input
              ...
              name="example"
              value="data.py"
              checked={selection === "data.py"}
              onChange={() => setSelection("data.py")}
            />
          ...
          <div>
            <input
              ...
              name="example"
              value="data.r"
              checked={selection === "data.r"}
              onChange={() => setSelection("data.r")}
            />
          ...
          <div>
            <input
              ...
              name="example"
              value="analysis.py"
              checked={selection === "analysis.py"}
              onChange={() => setSelection("analysis.py")}
            />
          ...
          <div>
            <input
              ...
              name="example"
              value="analysis.r"
              checked={selection === "analysis.r"}
              onChange={() => setSelection("analysis.r")}
            />
          ...
          {selection === "data.py" ? (
            <div>
              <p>
                This is an example of how data generation via Python script
                might work. It uses Pyodide in the browser.
              </p>
              <p>
                The value of the global variable <code>data</code> is used to
                pass data from the Python script to the output window.
              </p>
            </div>
          ) : selection === "data.r" ? (
            <div>
              <p>
                This is an example of how data generation via R script might
                work. It uses webr in the browser.
              </p>
              <p>
                The value of the global variable <code>data</code> is used to
                pass data from the R script to the output window.
              </p>
            </div>
            ...
            <div>
              <p>
                This is an example of how downstream analysis via R script might
                work. It uses webr in the browser.
              </p>
            </div>
          ) : (
      ...
      >
        {selection === "data.py" ? (
          <DataPyPrototype width={width - leftPanelWidth} height={height} />
        ) : selection === "data.r" ? (
