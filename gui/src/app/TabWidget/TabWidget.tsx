        ...
        >
            ...
            </div>
            {
                children2.map((c, i) => {
                    ...
                    return (
                        <div key={`child-${i}`} style={{visibility: visible ? 'visible' : 'hidden', overflowY: 'hidden', overflowX: 'hidden', position: 'absolute', left: 0, top: tabBarHeight, width: W, height: H, background: 'white'}}>
